    ...
    return (
        nft ? (
                ...
                <div className='h-screen absolute z-10'>
                    ...
                    <div className='grid grid-cols-3 gap-2'>
                        ...
                        <div className='text-left mt-8 ml-16'>
                            ...
                            <div className={`${rubik.className} flex flex-col mt-6 text-slate-200`}>
                                ...
                                {address != nft.owner && <div>Owner: {nft.owner}</div>}
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        >
                            <span className="absolute inset-0 bg-red-700 transform -translate-y-full transition-transform duration-300 ease-in-out group-hover:translate-y-0"></span>
                            <span className="relative z-10">
                                Train {address == nft.owner ? "Your" : "This"} Pet
                            </span>
                        </button>
                        <button
            ...
            <div className={`${ubuntu.className} text-transparent h-20 bg-clip-text bg-gradient-to-r from-white to-blue-400 font-bold text-5xl py-48 h-screen`}>
                <h1 className="text-center">Pet with id: {tokenId} not found</h1>
            </div>
        )
    )
}